#!/bin/bash
#SBATCH --job-name=DataAug50Agree
#SBATCH --nodes=1
...
python3 /home/m/mehrad/brikiyou/scratch/ift6289/IFT6289-project/stock_predictor_sentiment_analysis/dora_fine-tuning/data_augmentation.py --path /home/m/mehrad/brikiyou/scratch/ift6289/IFT6289-project/data/FinancialPhraseBank-v1.0/Sentences_50Agree_utf8.txt --skip 669